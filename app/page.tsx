            ...
            <div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
              ...
              <div className="sm:text-right">
                <p className="text-sm font-bold text-blue-600">
                  🎁 All current tools are completely free
                </p>
            ...
            <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
              ...
              <div>
                ...
                <div className="mt-3 flex flex-col items-start gap-2 text-sm text-zinc-500">
                  ...
                  <Link href="/report-issue" className="transition hover:text-blue-600">
                    Report an Issue
                  </Link>

                  <a href="mailto:support@makeudocs.com" className="transition hover:text-blue-600">
