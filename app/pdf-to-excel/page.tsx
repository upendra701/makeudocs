  ...
  const extract = async () => {
    ...
    try {
      ...
      for (let pageNumber = 1; pageNumber <= pdf.numPages; pageNumber++) {
        ...
        setProgress(Math.round((pageNumber / pdf.numPages) * 100)); page.cleanup(); await new Promise((resolve) => setTimeout(resolve, 0));
      }
  ...
  return (
    <main className="min-h-screen bg-[radial-gradient(circle_at_50%_0%,rgba(219,234,254,.72),transparent_34rem),linear-gradient(180deg,#f8fbff_0%,#f8fafc_45%,#fff_100%)] px-4 py-10 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-6xl">
        <section className="mx-auto max-w-3xl text-center"><div className="mb-4 inline-flex items-center gap-2 rounded-full border border-blue-100 bg-white/80 px-3 py-1 text-xs font-semibold text-blue-700 shadow-sm"><span className="h-1.5 w-1.5 rounded-full bg-blue-600" /> Browser-based PDF table extraction</div><h1 className="text-4xl font-bold tracking-tight text-zinc-950 sm:text-5xl">PDF to Excel</h1><p className="mx-auto mt-4 max-w-2xl text-base leading-7 text-zinc-600 sm:text-lg">Extract selectable PDF text and table-like columns into a real Excel workbook. Your PDF is processed in your browser.</p></section>
