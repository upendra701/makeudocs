...
export const tools: Tool[] = [
  {
    name: "Image to PDF",
    description: "Convert JPG, PNG and other images to PDF in your browser.",
    href: "/image-to-pdf",
    category: "Convert",
    status: "available",
  },
  ...
  },
  {
    ...
    description: "Create passport-size photos for common document needs.",
    href: "/passport-photo",
  ...
  {
    name: "Edit PDF",
    description: "Add text, shapes, highlights and annotations to PDF files.",
    href: "/edit-pdf",
    category: "PDF Tools",
    status: "coming-soon",
  },
  ...
  {
    name: "Rotate PDF",
    description: "Rotate PDF pages and save a corrected document.",
    href: "/rotate-pdf",
    category: "PDF Tools",
    status: "coming-soon",
  },
  ...
  {
    name: "PDF to Excel",
    description: "Extract useful PDF tables into Excel format.",
    href: "/pdf-to-excel",
    category: "Convert",
    status: "coming-soon",
  },
  {
    ...
    description: "Convert PDF content into presentation slides.",
    href: "/pdf-to-ppt",
    category: "Convert",
    status: "coming-soon",
  },
  ...
  },
  {
    ...
    description: "Reduce image file size for sharing and uploads.",
    href: "/compress-image",
    category: "Image Tools",
    status: "coming-soon",
  },
  ...
  },
  {
    ...
    description: "Create clear summaries from long documents.",
  ...
  },
  {
    ...
    description: "Create professional invoices and export them to PDF.",
  ...
  },
  {
    ...
    description: "Create simple business quotations and export them to PDF.",
