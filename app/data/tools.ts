...
export const tools: Tool[] = [
  ...
  { name: "Edit PDF", description: "Add text, shapes, highlights and annotations to PDF files.", href: "/edit-pdf", category: "PDF Tools", status: "coming-soon" },
  { name: "Split PDF", description: "Split a PDF into separate files or selected page ranges.", href: "/split-pdf", category: "PDF Tools", status: "coming-soon" },
  { name: "Rotate PDF", description: "Rotate PDF pages and save a corrected document.", href: "/rotate-pdf", category: "PDF Tools", status: "coming-soon" },
